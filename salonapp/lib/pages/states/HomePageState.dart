...
import 'package:salonapp/widgets/image_card.dart';
import 'package:salonapp/widgets/my_column.dart';
import 'package:salonapp/widgets/specialist_column.dart';
              ...
              Row(
                ...
                children: <Widget>[
                  Expanded(
                    child: InkWell(
                      onTap: () =>
                          Navigator.of(context, rootNavigator: true).pushNamed(UIData.bookPageRoute),
                      child: MyColumn(
